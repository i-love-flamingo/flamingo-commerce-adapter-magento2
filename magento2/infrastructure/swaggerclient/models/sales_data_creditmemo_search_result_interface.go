...
// swagger:model sales-data-creditmemo-search-result-interface
...
// Validate validates this sales data creditmemo search result interface
func (m *SalesDataCreditmemoSearchResultInterface) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SalesDataCreditmemoSearchResultInterface) validateItems(formats strfmt.Registry) error {
...
func (m *SalesDataCreditmemoSearchResultInterface) validateSearchCriteria(formats strfmt.Registry) error {
...
func (m *SalesDataCreditmemoSearchResultInterface) validateTotalCount(formats strfmt.Registry) error {
...
func (m *SalesDataCreditmemoSearchResultInterface) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SalesDataCreditmemoSearchResultInterface) UnmarshalBinary(b []byte) error {
	var res SalesDataCreditmemoSearchResultInterface
