...
// swagger:model sales-data-order-item-search-result-interface
...
// Validate validates this sales data order item search result interface
func (m *SalesDataOrderItemSearchResultInterface) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SalesDataOrderItemSearchResultInterface) validateItems(formats strfmt.Registry) error {
...
func (m *SalesDataOrderItemSearchResultInterface) validateSearchCriteria(formats strfmt.Registry) error {
...
func (m *SalesDataOrderItemSearchResultInterface) validateTotalCount(formats strfmt.Registry) error {
...
func (m *SalesDataOrderItemSearchResultInterface) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SalesDataOrderItemSearchResultInterface) UnmarshalBinary(b []byte) error {
	var res SalesDataOrderItemSearchResultInterface
